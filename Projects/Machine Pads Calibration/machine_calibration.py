# This code is meant for the calibration of the Load Cells, when
# needed. It exports the CSV file with the results of each attempt.
# It works in association with the Load Cells Calibration excel
# file, for better visualisation of the data. Data from Machine
# comes as (R1,R2,R3,L1,L2,L3). Use Load Cells Calibration Excel
# to fill in details.
##########################
